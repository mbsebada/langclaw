...
const API_KEY = process.env.ZALO_SERVICE_API_KEY || "dev-secret-key";
...
app.use((req, res, next) => {
  ...
  // Compare byte lengths first to prevent timing attacks,
  // then use timingSafeEqual to safely compare contents.
